...
<?php
	...
	$ac = array(
		...
		"ac_blog_r" =>     array("да чете блога", "ако изберете &laquo;никто&raquo; то линкът към блога ще изчезне от менюто на првода"),
		...
		"ac_book_edit" =>  array("да редактира описанието на превода", "промяна на името, описанието, езиците на перевода, качване на нова картинка"),
...
<?php
	...
	echo $form->dropDownListRow(
		$book, "facecontrol",
		array(Book::FC_OPEN => "нет группы", Book::FC_CONFIRM => "след потвърждение на модераторите", Book::FC_INVITE => "само с покана от модераторите"),
