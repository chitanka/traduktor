...
<?php
	...
	$ac = array(
		"ac_read" =>       array("да влиза<sup>*</sup>", "кто может в принципе зайти на любую страницу перевода; можно указать для каждой главы индивидуально"),
		"ac_trread" =>     array("да вижда чуждите версии<sup>*</sup>", "кому видны все предложенные версии перевода"),
		"ac_gen" =>        array("да сваля резултата<sup>*</sup>", "можно указать для каждой главы индивидуально"),
		"ac_rate" =>       array("да оценява превода<sup>*</sup>", "можно указать для каждой главы индивидуально"),
		"ac_comment" =>    array("да коментира превода<sup>*</sup>", "можно указать для каждой главы индивидуально"),
		"ac_tr" =>         array("да превежда<sup>*</sup>", "добавлять новые версии перевода; можно указать для каждой главы индивидуально"),

		"ac_blog_r" =>     array("да чете блога", "если выбрать &laquo;никто&raquo; то ссылка на блог вообще исчезнет из меню перевода"),
		"ac_blog_c" =>     array("да коментира в блога", "оставлять комментарии в блоге перевода"),
		"ac_blog_w" =>     array("да пише в блога", "писать посты в блоге перевода"),

		"ac_announce" =>   array("да анонсира", "размещать анонсы перевода в <a href='/announce/'>соответствующем разделе</a>."),
		"ac_chap_edit" =>  array("да редактира оригинала", "добавлять/изменять главы, импортировать и редактировать оригинал"),
		"ac_book_edit" =>  array("да редактира описанието на превода", "изменять название, описание, языки перевода, загружать новую картинку"),
		"ac_membership" => array("да управлява групата на превода", "рассматривать заявки на вступление в группу перевода, удалять из группы, приглашать в группу"),
	);
