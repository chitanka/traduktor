...
<div class='tools'>
	...
	<dl class='info'>
		...
		<dt>Брой сваляния:</dt>
		<dd>
			<span rel='popover' data-content='Смятат се само качвания от уникални IP адреси. Понякога компютрите от една домашна или офисна мрежа имат еднакъв IP-адрес, затова гледайте на тези цифри като примерна, занижена оценка.' data-title="Откуда берутся эти цифры?">
			<?php
				echo "{$book->n_dl} чов.";
