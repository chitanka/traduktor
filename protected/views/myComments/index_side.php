...
<p>
	Посмотрите направо. Увидев вещь, которой вы не пользовались больше года, выкиньте её. Теперь посмотрите налево, в центр экрана. Здесь вы видите фрагменты оригинала, к которым вы когда-либо оставляли комментарии или просто решили следить за дискуссиями в них.
</p>
...
<?php if(false && !Yii::app()->user->isGuest) { ?>( <a href='/blog/edit/' class='act'>написать пост в общем блоге</a> )<?php } ?>
</div>
