...
<div class="row">
	<div class="span7" id="f-hot">
		<h2>
			...
			<a href="#" data-toggle="modal" data-target="#f-hot-ini" class="cog" title="Настройка външния вид на този блок"><i class='icon-cog'></i></a>
		</h2>
		<?php
	...
	<div class="span5" id="f-about">
		<div class='hero'>
			...
			<p>
				Също така на вашите услуги е <a href="/site/help">система за определяне  правата за достъп</a>, колективен блог на превода, коментиране на фрагменти, разнообразна статистика.
			</p>
			<p>Опитайте сами!</p>
			<h3>Какво ще получите?</h3>
			<ol>
