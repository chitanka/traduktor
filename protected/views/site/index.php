...
<div class="row">
	...
	<div class="span5" id="f-about">
		<div class='hero'>
			...
			<p>
				Привет. Добро пожаловать в систему управления коллективным разумом &laquo;КУРСОМИР.ПЕРЕВОДЫ&raquo;<small>, основанной на проекте &laquo;Нотабеноид&raquo;</small>. Этот сайт предназначен для коллективных переводов любых текстов и субтитров на разные языки.
			</p>
